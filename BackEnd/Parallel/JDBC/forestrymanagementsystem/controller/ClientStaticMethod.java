...
import com.cap.forestrymanagementsystem.validation.DateValidation;
import com.cap.forestrymanagementsystem.validation.DayValidation;
...
public class ClientStaticMethod {
	...
	public static void updateInventoryProduct() {
		...
		if(clientService.updateProduct(product.getProductId(),product.getProductName())){
